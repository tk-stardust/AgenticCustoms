    ...
    <div class="layout">
      ...
      <div class="panel panel-form">
        ...
        <el-form :model="form" label-position="top">
          ...
          <div class="field-group">
            <label class="field-label"><span class="required-dot"></span>商品描述</label>
            <el-input v-model="form.description" type="textarea" :rows="4"
              placeholder="描述外观、材质、功能、用途..." class="custom-textarea" resize="vertical"/>
          </div>
          <div v-if="form.material||form.function||form.usage" class="ai-extract">
            <div class="ai-badge"><el-icon :size="14"><MagicStick/></el-icon><span>AI 自动识别</span></div>
            <div class="extract-tags">
              <span v-if="form.material" class="extract-tag">材质：<b>{{ form.material }}</b></span>
              <span v-if="form.function" class="extract-tag">功能：<b>{{ form.function }}</b></span>
              <span v-if="form.usage" class="extract-tag">用途：<b>{{ form.usage }}</b></span>
            </div>
          </div>
          <el-row v-else :gutter="12">
            <el-col :span="8"><el-form-item label="材质"><el-input v-model="form.material" placeholder="塑料/金属"/></el-form-item></el-col>
            <el-col :span="8"><el-form-item label="功能"><el-input v-model="form.function" placeholder="音乐播放"/></el-form-item></el-col>
            <el-col :span="8"><el-form-item label="用途"><el-input v-model="form.usage" placeholder="家庭娱乐"/></el-form-item></el-col>
          </el-row>
          <div class="btn-group">
...
.required-dot{display:inline-block;width:6px;height:6px;border-radius:50%;background:#0d9488;flex-shrink:0}
...
:deep(.custom-textarea .el-textarea__inner){border-radius:10px;border:1px solid #e2e8f0;box-shadow:none;resize:vertical;min-height:100px;font-size:14px}
