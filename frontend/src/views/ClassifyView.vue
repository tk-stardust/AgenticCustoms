      ...
      <div class="panel panel-form">
        ...
        <el-form :model="form" label-position="top">
          ...
          <div class="btn-group">
            ...
            <button type="button" class="btn-ghost" @click="clearForm()" :disabled="store.classifyLoading">清空表单</button>
            <button v-if="store.hsResult" type="button" class="btn-ghost" @click="clearResult()">清除结果</button>
          </div>
        </el-form>
      </div>
